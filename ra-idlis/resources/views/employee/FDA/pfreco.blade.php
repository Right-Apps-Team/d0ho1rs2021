                  ...
                  <div class="col-sm-5">
                      <table class="table table-borderless table-sm">
                        ...
                        <tbody>
                          ...
                          <tr>
                            <th scope="row">Time :</th>
                            <td>@isset($AppData->CashierApproveTimeFDA) <span style="color:green;font-weight: bolder">{{$AppData->CashierApproveTimeFDA}}</span> @else <span style="color:red;font-weight: bolder">Not Available</span> @endisset</td>
                          </tr>
                          <tr>
                            <th scope="row">Date :</th>
                            <td>@isset($AppData->CashierApproveDateFDA) <span style="color:green;font-weight: bolder">{{$AppData->CashierApproveDateFDA}}</span> @else <span style="color:red;font-weight: bolder">Not Available</span> @endisset</td>
                          </tr>
                          <tr>
                            <th scope="row">Evaluated by:</th>
                  ...
                  <div class="col-sm-5">
                      <table class="table table-borderless table-sm">
                        ...
                        <tbody>
                          ...
                          <tr>
                            <th scope="row">Time :</th>
                            <td>@isset($AppData->CashierApproveTimePharma) <span style="color:green;font-weight: bolder">{{$AppData->CashierApproveTimePharma}}</span> @else <span style="color:red;font-weight: bolder">Not Available</span> @endisset</td>
                          </tr>
                          <tr>
                            <th scope="row">Date :</th>
                            <td>@isset($AppData->CashierApproveDatePharma) <span style="color:green;font-weight: bolder">{{$AppData->CashierApproveDatePharma}}</span> @else <span style="color:red;font-weight: bolder">Not Available</span> @endisset</td>
                          </tr>
                          <tr>
                            <th scope="row">Evaluated by:</th>

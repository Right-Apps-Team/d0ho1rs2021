  ...
  <div class="content p-4">
      <div class="card">
          <div class="card-header bg-white font-weight-bold">
             Cashiering  (Radiation Facility) @include('employee.tableDateSearch')
          </div>
                  ...
                  <tbody id="FilterdBody">  
                      @if (isset($BigData))
                        ...
                        @foreach ($BigData as $data)
                          @if($data->isPayEvalFDA == 1 && strtolower($data->hfser_id) == 'lto' && $data->isReadyForInspecFDA == 1 && $data->isPayEvalFDA == 1 )
                          <!-- if($data->isPayEvalFDA == 1 && strtolower($data->hfser_id) == 'lto' && $data->isReadyForInspecFDA == 1 && $data->isPayEvalFDA == 1 && $data->ispreassessed == 1) -->
                              ...
                              <tr>
                                ...
                                <td class="text-center" style="font-weight:bold;">{{$data->proofpaystatMach == 'posting' ? 'For Posting' :($data->proofpaystatMach == 'posted' ? 'Posted' : 'For Payment')}}</td>

    ...
    <div class="content p-4">
            ...
            <tbody>
                ...
                @endif
                    ...
                    <td>
                        ...
                        <i style="cursor: pointer; " onclick="updateFee('{{$value->id}}','{{$value->ocid}}','{{$value->facmode}}','{{$value->funcid}}','{{$value->initial_new_amount}}','{{$value->renewal_amount}}','{{$value->initial_change_amount}}','{{$value->renewal_period}}','{{$value->remarks}}','{{$value->isPenalties}}')" data-toggle="modal" data-target="#upModal" class="fa fa-edit"></i>
        ...
        <script>
            ...
            function updateFee(id, ocid, facmode, funcid, initial_new_amount, renewal_amount, initial_change_amount, renewal_period, remarks, isPenalties) {
                $('#upid').val(id)
                $('#upocid').val(ocid)

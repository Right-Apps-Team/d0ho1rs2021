  ...
  <div class="content p-4">
      ...
      <div class="card">
          <div class="card-header bg-white font-weight-bold">
             Team <span class="TM001_add" ><a href="#" title="Add New Team" data-toggle="modal" data-target="#myModal"><button class="btn btn-primarys"><i class="fa fa-plus-circle" style="cursor: pointer;"></i>&nbsp;Add new</button></a></span>
          </div>
          <div class="card-body">

...
console.log($(who).val())
      ...
      function changeFaciMonitoring(){;
         ...
         if(facId != "") {
            ...
            facName.open("GET", "{{asset('employee/dashboard/others/getFacNameByFacid')}}"+facId+'/'+($("#cmidVal").length ? $('#cmidVal').val() : ''), true);
      ...
      function changeFaciSelect(){
         ...
         var facId = (typeof(document.getElementById('xfacName')) != 'null' ? document.getElementById('xfacName').value : document.getElementById('facName').value);
...
//////////////////////////// lloyd - Dec 7, 2018 //////////////////////////////
   ...
   facAddr.onreadystatechange = function() {
      ...
      if (this.readyState == 4 && this.status == 200) {
         ...
         var appid = ($("#xfacName").length > 0 ? $("#xfacName").val() : $("#facName").val());
         // var appid = document.getElementById('facName').value;
  ...
  //////////////////////////// modal - Dec 10, 2018 ////////////////////////////// 
   ...
   function novextra(dom){
      ...
      var value = $('#mon_tech_dire').val();

      if(value.length > 1 && value.includes("3")) {
         novext.open("GET", "{{asset('employee/dashboard/monitor/getNovDirection')}}"+"3", true);
         novext.send();
      } else {

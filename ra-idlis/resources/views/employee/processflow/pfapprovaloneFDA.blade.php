...
<div class="content p-4">
    <div class="card">
        ...
        <div class="accordion" id="accordionExample">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <center>
                      @isset($AppData)
                        @if($AppData->isPayEval != null)
                          <button class="btn btn-primarys" onclick="window.location.href='{{ asset('/employee/dashboard/processflow/actions') }}/{{$AppData->appid}}/{{$AppData->aptid}}'"><i class="fa fa-eye" aria-hidden="true"></i>&nbsp;View Cashier Evaluation</button>
                        @else
                          &nbsp;
                        @endif
                      @endisset
          ...
          <div class="card">
            {{-- START HEAD --}}
            <div class="card-header @isset($AppData) @if($AppData->isCashierApprove == null) list-group-item-info @elseif($AppData->isCashierApprove == 1) list-group-item-success  @else list-group-item-danger @endif @endisset" id="headingOne" data-toggle="collapse" data-target="#collapseFive" aria-expanded="true" aria-controls="collapseOne" style="">
              <div class="mb-0">
                <button class="btn btn-link @isset($AppData) @if($AppData->isCashierApprove == null) list-group-item-info @elseif($AppData->isCashierApprove == 1) list-group-item-success  @else list-group-item-danger @endif @endisset" type="button" style="text-decoration:none">
        ...
        @isset($AppData)
          ...
          <div class="container">
            <center>
              <button class="btn btn-primarys" onclick="toggleModal(true)" style="background-color: #28a745" data-toggle="modal" data-target="#AccepttGodModal">Approve (FDA)</button>&nbsp;
              <button class="btn btn-primarys" onclick="toggleModal(false)" style="background-color: #FF2200" data-toggle="modal" data-target="#AccepttGodModal">Reject (FDA)</button>
            </center>
          </div>
          @endif     
        @endisset
              ...
              <div class="container">
                  ...
                  <form id="AppFormFinal" data-parsley-validate>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-8" >
                          <input type="password" class="form-control" rows="5" id="chckpass" data-parsley-required-message="<strong>Password<strong> required." required=""></input>
                        </div>
                    </div>

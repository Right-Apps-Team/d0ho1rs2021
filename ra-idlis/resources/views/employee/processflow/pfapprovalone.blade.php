    ...
    <div class="card">
      @php $count = 0; @endphp
        ...
        <div class="accordion" id="accordionExample">
                  ...
                  <div class="col-sm-5">
                      <table class="table table-borderless table-sm">
                        ...
                        <tbody>
                          ...
                          <tr>
                            <th scope="row">Time :</th>
                            <td>@isset($AppData->FCashierApproveTime) <span style="color:green;font-weight: bolder">{{$AppData->FCashierApproveTime}}</span> @else <span style="color:red;font-weight: bolder">Not Available</span> @endisset</td>
                          </tr>
                          <tr>
                            <th scope="row">Date :</th>
                            <td>@isset($AppData->FCashierApproveDate) <span style="color:green;font-weight: bolder">{{$AppData->FCashierApproveDate}}</span> @else <span style="color:red;font-weight: bolder">Not Available</span> @endisset</td>
                          </tr>
                          <tr>
                            <th scope="row">Evaluated by:</th>
                            <td>@isset($AppData->CashierEvaluator) <span style="color:green;font-weight: bolder">{{$AppData->CashierEvaluator}}</span> @else <span style="color:red;font-weight: bolder">Not Available</span> @endisset</td>
                          </tr>
                        </tbody>
                      </table>  
                  </div>
          ...
          {{-- /////////////////// --}}
          {{-- /////////////////// --}}
          @if(strtolower($AppData->hfser_id) == 'lto' || strtolower($AppData->hfser_id) == 'coa')
          <div class="card">
            {{-- START HEAD --}}
          ...
          {{-- /////////////////// --}}
           @if(strtolower($AppData->hfser_id) == 'lto' && isset($canView[1]) && $canView[1])
            ...
            @if($AppData->isApproveFDA != 1 && isset($canView[1]) && $canView[1])
              @php $count++ @endphp
            @endif
                    ...
                    <div class="col-sm-5">
                        <table class="table table-borderless table-sm">
                          ...
                          <tbody>
                            <tr>
                              <th scope="row">Status :</th>
                              <td>@isset($AppData) @if($AppData->isApproveFDA == null) <span style="color:blue;font-weight: bolder">Not Inspected</span> @elseif($AppData->isApproveFDA == 1)<span style="color:green;font-weight: bolder">COC Approve</span>@else<span style="color:red;font-weight: bolder">COC Denied</span>@endif @endisset</td>
                            </tr>
                            <tr>
                              <th scope="row">Date :</th>

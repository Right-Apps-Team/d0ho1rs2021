			...
			<div class="card-header">
				<div class="row">
					...
					<div class="col-md-6">
						...
						<span class="card-title text-center" style="font-family: Arial;font-size: 13pt"><center><strong><?=(isset($retTable[0]->iso_desc) && !empty($retTable[0]->address)? $retTable[0]->iso_desc : '')?></strong></center></span>
					</div>

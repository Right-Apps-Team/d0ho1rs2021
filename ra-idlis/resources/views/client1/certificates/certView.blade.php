			...
			<div class="card-header">
				<div class="row">
					...
					<div class="col-md-6">
						...
						<span class="card-title text-center" style="font-family: Arial;font-size: 14pt"><center><strong><?=(isset($retTable[0]->office) && !empty($retTable[0]->office)? $retTable[0]->office.' FOR ' : '')?>HEALTH FACILITIES AND SERVICES REGULATORY BUREAU</strong></center></span>
					</div>
